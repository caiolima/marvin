...
void shell_cmd_list(int argc)
{
  ...
  if (argc == 2) {
    ...
    if (strcmp(arg, "add")) {
      ...
      list_add(&element1, &element0);

      print("Element1 address "); print_hex((u32int) &element1);
      print("\nElement0.next address "); print_hex((u32int) element0.next);
      print("\n");
      return;
    }
  } 
